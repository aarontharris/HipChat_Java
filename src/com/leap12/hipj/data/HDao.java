...
public class HDao {
	...
	public HipChatIncomingMsg toHipChatIncomingMsg(String jsonString) {
		return gson.fromJson(jsonString, HipChatIncomingMsg.class);
	}

	public String toString(HipChatIncomingMsg msg) {
